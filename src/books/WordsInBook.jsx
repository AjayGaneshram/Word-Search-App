...
//       {/* Header */}
//       <div className="bg-[#986249] h-16 w-full flex items-center justify-between px-4">
//         <h1 className="text-2xl font-bold text-white truncate">
//           நூல்: {decodedBookName}
//         </h1>
//         <button
//           onClick={() => navigate(-1)}
//           className="px-4 py-2 bg-white text-[#991b1b] rounded-md shadow-xl hover:bg-orange-100"
//         >
//           Home
//         </button>
//       </div>
    ...
    <div className="bg-[#fef2f2]">
      ...
      <div className="p-6 max-w-4xl mx-auto bg-gray-50 min-h-screen relative">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-extrabold text-[#dc2626] mb-6">
            {decodedBookName}
          </h1>
